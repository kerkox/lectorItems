...
import lectoritems.DAO.exceptions.NonexistentEntityException;
import lectoritems.DAO.exceptions.PreexistingEntityException;
import lectoritems.Item;
...
public class ItemJpaController implements Serializable {
    ...
    public void create(Item item) throws PreexistingEntityException, Exception {
        ...
        try {
            ...
            if (findItem(item.getId_item()) != null) {
